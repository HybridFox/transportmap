...
## Create OSRM data
```bash
sudo curl http://download.geofabrik.de/europe/belgium-latest.osm.pbf --output belgium-latest.osm.pbf
sudo docker run -t -v "/opt/transportmap-osrm:/data" ghcr.io/project-osrm/osrm-backend osrm-extract -p /data/train.lua /data/belgium-latest.osm.pbf
sudo docker run -t -v "/opt/transportmap-osrm:/data" ghcr.io/project-osrm/osrm-backend osrm-partition /data/belgium-latest.osm.pbf
sudo docker run -t -v "/opt/transportmap-osrm:/data" ghcr.io/project-osrm/osrm-backend osrm-customize /data/belgium-latest.osm.pbf
```